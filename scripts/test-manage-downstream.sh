...
test_fresh_install_and_reinstall() {
  ...
  assert_file_contains "${repo_path}/AGENTS.md" "\`AGENTS.md\` is the entrypoint for repo-local instructions, not the complete Bright Builds specification." "root AGENTS should define AGENTS as the local entrypoint rather than the full spec"
  ...
  assert_file_contains "${repo_path}/AGENTS.bright-builds.md" "\`AGENTS.md\` is the entrypoint for repo-local instructions, not a complete Bright Builds spec." "sidecar should state that AGENTS is not the full Bright Builds spec"
  ...
  assert_file_contains "${repo_path}/AGENTS.bright-builds.md" "Use this file, \`AGENTS.bright-builds.md\`, for the Bright Builds default workflow" "sidecar should position itself as the detailed Bright Builds layer"
  ...
  assert_file_contains "${repo_path}/CONTRIBUTING.md" "Treat \`AGENTS.md\` as the entrypoint for repo-local instructions, not the complete Bright Builds spec." "CONTRIBUTING should explain that AGENTS is the local entrypoint rather than the full spec"
