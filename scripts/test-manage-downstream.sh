...
test_fresh_install_and_reinstall() {
  ...
  assert_file_contains "${repo_path}/AGENTS.bright-builds.md" "Before substantive implementation work, sync first: fetch remote state before editing" "sidecar should include the explicit sync-first pre-work guidance"
  ...
  assert_file_contains "${repo_path}/AGENTS.bright-builds.md" "\`git pull --rebase\` when local guidance uses it" "sidecar should frame git pull --rebase as an example rather than a universal command"
  ...
  assert_file_contains "${repo_path}/CONTRIBUTING.md" "Before substantive implementation work, sync first: fetch remote state before editing" "CONTRIBUTING should require explicit sync-first pre-work guidance"
  ...
  assert_file_contains "${repo_path}/CONTRIBUTING.md" "\`git pull --rebase\` when local guidance uses it" "CONTRIBUTING should frame git pull --rebase as an example rather than a universal command"
