...
test_fresh_install_and_reinstall() {
  ...
  assert_file_contains "${repo_path}/AGENTS.bright-builds.md" "Before committing, run the relevant repo-native verification steps for the changed paths and do not commit if they fail." "sidecar should include the pass-before-commit verification rule"
  ...
  assert_file_contains "${repo_path}/CONTRIBUTING.md" "Before committing, run the relevant repo-native verification steps for the changed paths and do not commit if they fail." "CONTRIBUTING should require pass-before-commit verification"
