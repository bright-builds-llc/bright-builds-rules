...
- [ ] `bun scripts/bright-builds-check.ts all` ran and passed, or every intentional exact-file or trailing-slash directory exception has a reason in `.bright-builds-rules-checks.tsv`
